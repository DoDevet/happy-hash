  ...
  return (
    <div className="flex items-center justify-between px-4 py-2">
      <div>
        ...
        <p className="text-xs text-gray-600">{getDateTimeFormat(createdAt)}</p>
      </div>
      <div className="flex space-x-2 ">
        <div className="relative flex flex-col items-center justify-center">
          ...
          <span className="absolute -bottom-3 text-[1px]">{likes}</span>
        </div>
        <div className="relative flex flex-col items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="absolute -bottom-3 text-[1px]">{comments}</span>
        </div>
      </div>
    </div>
  );
