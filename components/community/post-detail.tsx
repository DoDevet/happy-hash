...
export default function PostDetail() {
  ...
  return (
    <div className="no-scroll max-h-[70%] min-w-[300px] max-w-xl overflow-y-scroll scroll-smooth rounded-md bg-white">
      <div className="pb-20">
        <div className="relative flex w-full items-center justify-center py-4">
          <span className="text-xl font-bold">{data?.post?.title}</span>

          <span
            className="absolute right-10 cursor-pointer text-xl font-semibold"
            onClick={() => router.back()}
          >
            X
          </span>
